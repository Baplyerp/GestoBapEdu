...
# ==========================================
    ...
    if selecao == "Hub Central":
       ...
       # --- 2. RENDERIZAÇÃO DA TELA (Revisada) ---
        else:
            ...
            with Session(get_engine()) as session:
                ...
                if questao:
                    ...
                    # Enunciado Rico (Agora dentro do if questao!)
                    ...
                    # Ordenamos as alternativas por letra para não aparecerem embaralhadas
                    for alt in sorted(alternativas, key=lambda x: x.letra):
